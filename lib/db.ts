...
function transformCatalogueFromDB(row: Database["public"]["Tables"]["catalogues"]["Row"]): Catalogue {
  return {
    id: row.id,
    name: row.name,
    slug: row.slug,
...
function transformCatalogueForDB(catalogue: Partial<Catalogue>): Database["public"]["Tables"]["catalogues"]["Insert"] {
  return {
    id: catalogue.id,
    name: catalogue.name!,
    slug: catalogue.slug!,
